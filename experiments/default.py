...
class Experiment(Config):
    ...
    ################################
    # Dataset name
    ds_name: Literal['emnist', 'fmnist', 'coil-20', 'coil-100'] = None
    # Image size.
    img_size: int = 28
    ################################
    #    Clustering Module         #
    ...
    clustering_loss_type: Literal['ddc'] = 'ddc'
    ...
    contrastive_type: Literal['simclr'] = 'simclr'
    # Projection layers.
